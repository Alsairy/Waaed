...
namespace Waaed.HR.Api.Migrations
{
    ...
    [Migration("20250628234908_UpdateHRModel")]
    partial class UpdateHRModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Waaed.HR.Api.Entities.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Waaed.HR.Api.Entities.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Waaed.HR.Api.Entities.JobApplication", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Waaed.HR.Api.Entities.LeaveRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Waaed.HR.Api.Entities.PerformanceReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Waaed.HR.Api.Entities.Position", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Waaed.HR.Api.Entities.Recruitment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Waaed.HR.Api.Entities.Department", b =>
                {
                    b.HasOne("Waaed.HR.Api.Entities.Employee", "HeadOfDepartment")
                        .WithMany()
                        .HasForeignKey("HeadOfDepartmentId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Waaed.HR.Api.Entities.Department", "ParentDepartment")
            ...
            modelBuilder.Entity("Waaed.HR.Api.Entities.Employee", b =>
                {
                    b.HasOne("Waaed.HR.Api.Entities.Department", "Department")
                        .WithMany("Employees")
                        .HasForeignKey("DepartmentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Waaed.HR.Api.Entities.Employee", "Manager")
                        .WithMany("Subordinates")
                        .HasForeignKey("ManagerId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Waaed.HR.Api.Entities.Position", "Position")
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("Waaed.HR.Api.Entities.JobApplication", b =>
                {
                    b.HasOne("Waaed.HR.Api.Entities.Employee", "InterviewedBy")
                        .WithMany()
                        .HasForeignKey("InterviewedById")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Waaed.HR.Api.Entities.Recruitment", "Recruitment")
            ...
            modelBuilder.Entity("Waaed.HR.Api.Entities.LeaveRequest", b =>
                {
                    b.HasOne("Waaed.HR.Api.Entities.Employee", "ApprovedBy")
                        .WithMany()
                        .HasForeignKey("ApprovedById")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Waaed.HR.Api.Entities.Employee", "Employee")
            ...
            modelBuilder.Entity("Waaed.HR.Api.Entities.PerformanceReview", b =>
                {
                    ...
                    b.HasOne("Waaed.HR.Api.Entities.Employee", "Reviewer")
            ...
            modelBuilder.Entity("Waaed.HR.Api.Entities.Recruitment", b =>
                {
                    b.HasOne("Waaed.HR.Api.Entities.Employee", "AssignedTo")
                        .WithMany()
                    ...
                    b.HasOne("Waaed.HR.Api.Entities.Employee", "RequestedBy")
                        .WithMany()
