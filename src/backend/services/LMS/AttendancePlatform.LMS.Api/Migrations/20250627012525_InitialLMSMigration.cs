        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseStructure = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MasteryThreshold = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    MasteryScale = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KeysetUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AuthTokenUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AuthLoginUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TargetLinkUri = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    TenantId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Placements = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastAssessed = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LTIToolId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CourseId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ResourceLinkId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    ResultSourcedId = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DelayedPostAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    AllowComments = table.Column<bool>(type: "bit", nullable: false),
                    RequireInitialPost = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LatePenaltyPercent = table.Column<int>(type: "int", nullable: true),
                    ...
                    PeerReviewEnabled = table.Column<bool>(type: "bit", nullable: false),
                    PeerReviewCount = table.Column<int>(type: "int", nullable: false),
                    PeerReviewDueDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    GroupAssignment = table.Column<bool>(type: "bit", nullable: false),
                    GroupSetId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModeratorUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    RequireModeratorApproval = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CanSubmitAssignments = table.Column<bool>(type: "bit", nullable: false),
                    CanParticipateDiscussions = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LockAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailableUntil = table.Column<DateTime>(type: "datetime2", nullable: true),
                    RequireInitialPost = table.Column<bool>(type: "bit", nullable: false),
                    AllowRating = table.Column<bool>(type: "bit", nullable: false),
                    SortByRating = table.Column<bool>(type: "bit", nullable: false),
                    OnlyGradersCanRate = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShowCorrectAnswersAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    OneQuestionAtATime = table.Column<bool>(type: "bit", nullable: false),
                    CantGoBack = table.Column<bool>(type: "bit", nullable: false),
                    AccessCode = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RequireLockdownBrowser = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManifestPath = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Version = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TemplateModuleId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Title = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Type = table.Column<int>(type: "int", nullable: false),
                    Content = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Position = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExcusedFromGrading = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SCORMAttemptId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    CorrectResponse = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Result = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Weighting = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
