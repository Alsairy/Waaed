...
class LeaveManagementService {
  ...
  async createLeaveRequest(request: CreateLeaveRequest): Promise<LeaveRequest> {
    try {
      ...
      throw new Error(axiosError.response?.data?.message || 'Failed to create leave request');
    }
  }
  ...
  async createPermissionRequest(request: CreatePermissionRequest): Promise<PermissionRequest> {
    try {
      ...
      const axiosError = error as { response?: { data?: { message?: string } } };
      throw new Error(axiosError.response?.data?.message || 'Failed to create permission request');
    }
  }
  ...
  async getLeaveRequests(
    ...
    try {
      ...
      const axiosError = error as { response?: { data?: { message?: string } } };
      throw new Error(axiosError.response?.data?.message || 'Failed to fetch leave requests');
    }
  }
  ...
  async getPermissionRequests(
    ...
    try {
      ...
      const axiosError = error as { response?: { data?: { message?: string } } };
      throw new Error(axiosError.response?.data?.message || 'Failed to fetch permission requests');
    }
  }
  ...
  async approveLeaveRequest(approval: ApprovalRequest): Promise<boolean> {
    try {
      ...
      const axiosError = error as { response?: { data?: { message?: string } } };
      throw new Error(axiosError.response?.data?.message || 'Failed to approve leave request');
    }
  }
  ...
  async rejectLeaveRequest(rejection: ApprovalRequest): Promise<boolean> {
    try {
      ...
      const axiosError = error as { response?: { data?: { message?: string } } };
      throw new Error(axiosError.response?.data?.message || 'Failed to reject leave request');
    }
  }
  ...
  async approvePermissionRequest(approval: ApprovalRequest): Promise<boolean> {
    try {
      ...
      const axiosError = error as { response?: { data?: { message?: string } } };
      throw new Error(axiosError.response?.data?.message || 'Failed to approve permission request');
    }
  }
  ...
  async rejectPermissionRequest(rejection: ApprovalRequest): Promise<boolean> {
    try {
      ...
      const axiosError = error as { response?: { data?: { message?: string } } };
      throw new Error(axiosError.response?.data?.message || 'Failed to reject permission request');
    }
  }
  ...
  async cancelLeaveRequest(requestId: string, reason?: string): Promise<boolean> {
    try {
      ...
      const axiosError = error as { response?: { data?: { message?: string } } };
      throw new Error(axiosError.response?.data?.message || 'Failed to cancel leave request');
    }
  }
  ...
  async cancelPermissionRequest(requestId: string, reason?: string): Promise<boolean> {
    try {
      ...
      const axiosError = error as { response?: { data?: { message?: string } } };
      throw new Error(axiosError.response?.data?.message || 'Failed to cancel permission request');
    }
  }
  ...
  async getLeaveBalance(userId?: string): Promise<LeaveBalance[]> {
    try {
      ...
      const axiosError = error as { response?: { data?: { message?: string } } };
      throw new Error(axiosError.response?.data?.message || 'Failed to fetch leave balance');
    }
  }
  ...
  async getLeaveTypes(): Promise<LeaveType[]> {
    try {
      ...
      const axiosError = error as { response?: { data?: { message?: string } } };
      throw new Error(axiosError.response?.data?.message || 'Failed to fetch leave types');
    }
  }
  ...
  async getLeaveCalendar(startDate: string, endDate: string, userId?: string): Promise<LeaveCalendarEvent[]> {
    try {
      ...
      const axiosError = error as { response?: { data?: { message?: string } } };
      throw new Error(axiosError.response?.data?.message || 'Failed to fetch leave calendar');
    }
  }
  ...
  async generateLeaveReport(
    ...
    try {
      ...
      const axiosError = error as { response?: { data?: { message?: string } } };
      throw new Error(axiosError.response?.data?.message || 'Failed to generate leave report');
    }
  }
  ...
  async getPendingApprovals(page: number = 1, pageSize: number = 50): Promise<{
    ...
    try {
      ...
      const axiosError = error as { response?: { data?: { message?: string } } };
      throw new Error(axiosError.response?.data?.message || 'Failed to fetch pending approvals');
    }
  }
  ...
  async getLeavePolicies(): Promise<LeavePolicy[]> {
    try {
      ...
      const axiosError = error as { response?: { data?: { message?: string } } };
      throw new Error(axiosError.response?.data?.message || 'Failed to fetch leave policies');
    }
  }
  ...
  async bulkApproveRequests(requestIds: string[], comments?: string): Promise<boolean> {
    try {
      ...
      const axiosError = error as { response?: { data?: { message?: string } } };
      throw new Error(axiosError.response?.data?.message || 'Failed to bulk approve requests');
    }
  }
  ...
  async getLeaveRequestById(requestId: string): Promise<LeaveRequest> {
    try {
      ...
      const axiosError = error as { response?: { data?: { message?: string } } };
      throw new Error(axiosError.response?.data?.message || 'Failed to fetch leave request');
    }
  }
  ...
  async getPermissionRequestById(requestId: string): Promise<PermissionRequest> {
    try {
      ...
      const axiosError = error as { response?: { data?: { message?: string } } };
      throw new Error(axiosError.response?.data?.message || 'Failed to fetch permission request');
    }
  }
}
